...
Route::post(__('cart') . '/addItem/{product}', 'CartController@addItem')->name('cart.add');
Route::delete(__('cart') . '/removeItem/{product}', 'CartController@removeItem')->name('cart.remove');
