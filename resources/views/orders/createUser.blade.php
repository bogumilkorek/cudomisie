...
<div class="panel panel-default">
  <div class="panel-body">
    ...
    <form method="POST" action="{{ route('user.orders.store') }}">
      ...
      <div class="form-group">
        <div class="checkbox">
          <label><input type="checkbox" name="accept-terms" value="" required>Akceptuję <a href="{{ route('user.pages.show', str_slug(__('Terms of use'))) }}" target="_blank">regulamin sklepu</a></label>
        </div>
      </div>

      <div class="form-group">
        <div class="checkbox">
          <label><input type="checkbox" name="accept-usage" value="" required>Wyrażam zgodę na przetwarzanie moich danych osobowych przez FHU Hurt - Krzyś (cudomisie.pl)<br />
