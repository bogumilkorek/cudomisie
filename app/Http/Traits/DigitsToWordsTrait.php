...
trait digitsToWordsTrait {
  ...
  // This function is obscure and needs refactoring.
  // You need to replace it to match your language.
  // You may use cleaner solutions like PHP's NumberFormatter class.
